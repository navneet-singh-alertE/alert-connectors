...
//	}
	...
	{
		String provResultString=null;
		String badgeId=null;
		if (this.getBadgeInformation()!=null)
			badgeId=this.getBadgeInformation().getBadgeId();
		provResultString=" ProvisioningResultAction-->"+this.getProvAction()+" ProvisioningResultIsFailed-->"+this.isProvFailed()
		+ " ProvisioningResultUserId-->"+this.getUserId()+ " ProvisioningResultBadgeInformation-->"+badgeId
		+ " ProvisioningResultMesgCode-->"+this.getMsgCode()+ " ProvisioningResultMesgDesc-->"+this.getMsgDesc();
		
		return provResultString;
	}
